...
const benefits = [
  {
    ...
    description: 'Libera a tu equipo de tareas repetitivas y enfócate en lo que realmente importa.',
  },
  {
    icon: <FaDollarSign size={50} />,
    title: 'Reduce costos operativos',
    description: 'Minimiza errores humanos y optimiza recursos con procesos automatizados.',
  },
  {
    icon: <FaChartLine size={50} />,
    title: 'Escala tu negocio',
    description: 'Crece sin límites. Las automatizaciones se adaptan a tu crecimiento.',
  },
  {
    icon: <FaShieldAlt size={50} />,
    title: 'Mayor precisión y control',
    description: 'Elimina errores manuales y mantén tus datos siempre actualizados.',
  },
  {
    icon: <FaUsers size={50} />,
    title: 'Mejora la productividad',
    description: 'Tu equipo puede enfocarse en tareas estratégicas de alto valor.',
  },
  {
    icon: <FaCheckCircle size={50} />,
    title: 'Integración total',
    description: 'Conecta todas tus herramientas favoritas en un solo flujo de trabajo.',
  },
];
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-lg border border-white/10 rounded-2xl p-6 md:p-8 h-full hover:border-[#E50914] transition-all duration-300">
                ...
                <motion.div
                  className="text-[#E50914] mb-4 md:mb-6 relative z-10"
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 relative z-10">
                  {benefit.title}
                </h3>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 mb-8 md:mb-10 max-w-3xl mx-auto">
              Únete a más de 500 empresas que ya están automatizando sus procesos con n8n
            </p>
            <button
              onClick={() => {
              ...
              className="bg-white text-[#E50914] font-bold py-4 px-10 md:py-5 md:px-12 rounded-full hover:bg-gray-100 transition-all transform hover:scale-105 shadow-2xl text-base md:text-lg"
            >
